  ...
  return (
    <div className="min-h-screen bg-black text-white  ">
      ...
      <div className=" max-w-screen-lg text-2xl  mx-auto pt-12  text-center  p-4 flex flex-col justify-center w-full h-full ">
        ...
        <p>
          This privacy notice for Freelance OS (&apos; Company,&apos; &apos;
          we,&apos; &apos; us,&apos; or &apos;our&apos;), describes how and why
        ...
        <p>
          ...
          contents below to find the section you are looking for. What personal
          ...
          interact with Freelance OS and the Services, the choices you make, and
          the products and features you use. Do we process any sensitive
          personal information? We do not process sensitive personal
          information. Do we receive any information from third parties? We may
          receive information from public databases, marketing partners, social
          media platforms, and other outside sources. How do we process your
          ...
          here to learn more. In what situations and with which parties do we
          share personal information? We may share information in specific
          situations and with specific third parties. What are your rights?
          Depending on where you are located geographically, the applicable
          privacy law may mean you have certain rights regarding your personal
          information. How do you exercise your rights? The easiest way to
        ...
        <p>
          ...
          information. However, this is solely done via Gumroad. You can read
          their Privacy Poliy{" "}
          <Link className="text-gray-500" href="https://gumroad.com/privacy">
            here{" "}
          </Link>{" "}
          .
        </p>
        ...
        <p>
          ...
          countries other than your own. Our servers are located in the USA or
          on the globally-distributed Edge Network from Vercel. Learn more about
          it{" "}
          <Link
          ...
          . If you are accessing our Services from outside, please be aware that
          ...
          PERSONAL INFORMATION?&apos; above), in and other countries. If you are
          a resident in the European Economic Area (EEA) or United Kingdom (UK),
          then these countries may not necessarily have data protection laws or
          other similar laws as comprehensive as those in your country. However,
        ...
        <p>
          ...
          to children under 18 years of age. By using the Services, you
        ...
        <p>
          ...
          time. If you are located in the EEA or UK and you believe we are
        ...
        <p>
          ...
          &apos;HOW CAN YOU CONTACT US ABOUT THIS NOTICE?&apos; below. However,
        ...
        <p>
          ...
          California, and have a registered account with Services, you have the
          right to request removal of unwanted data that you publicly post on
          the Services. To request removal of such data, please contact us using
          ...
          the Services, but please be aware that the data may not be completely
        ...
        <p>
          ...
          clicking{" "}
          <Link className="text-gray-500" href="/reachout">
            here
          </Link>{" "}
          .{" "}
        </p>
