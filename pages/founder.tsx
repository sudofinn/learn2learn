...
const Founder = () => {
  ...
  <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z"/>
        ...
        <a href="https://www.producthunt.com/@vimfinn" target="__blank" className="flex flex-row mx-auto my-2 bg-black text-white w-2/4 text-mirage-500 py-2 pl-2 rounded-md  border-r-4">
         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M13.337 9h-2.838v3h2.838a1.501 1.501 0 1 0 0-3z"/><path fill="currentColor" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10s10-4.477 10-10S17.523 2 12 2zm1.337 12h-2.838v3H8.501V7h4.837a3.498 3.498 0 0 1 3.499 3.499a3.499 3.499 0 0 1-3.5 3.501z"/></svg> 
          <h4 className="my-auto font-semibold mx-5">Product Hunt</h4>
        </a>
