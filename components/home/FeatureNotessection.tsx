        ...
        <h1   className="text-4xl xl:text-6xl  mt-32 xl:mt-64 inline-flex  px-14 py-6 mb-4 font-extrabold 
          ...
          ">Organize everything - sorted and in one place </h1>
            <ul className="   text-xl xl:text-2xl mx-[10px] sm:mx-[100px] lg:mx-[200px] xl:mx-[300px] 2xl:mx-[700px] ">
                      <li className=" mb-6 text-center font-extrabold ">Never say &apos;I don`t know where to put this link&apos;. Instead, embrace having a central system to archive any information.</li>
