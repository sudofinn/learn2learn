  ...
  return (
    <div  id="Features" className='text-center'>
        ...
        <h1   className="text-3xl xl:text-6xl   inline-flex  px-14 py-6 mb-4 font-extrabold 
          bg-pk text-black hover:bg-gray-200 duration-500 
          mx-[10px] sm:mx-[100px] lg:mx-[200px] xl:mx-[300px] 2xl:mx-[500px]  border-8 border-black rounded-xl
          ">See what needs to get done - with one look </h1>
            ...
            src={PrimaryGif}
            alt="The Header"
            className="mt-12 mx-auto mb-12 w-5/6  lg:w-2/3 border-8 border-black rounded-xl
