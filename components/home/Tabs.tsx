...
const Tabs = () => {
  ...
  */}
        ...
        <div className="grid grid-cols-1  gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            <div className="p-8 space-y-3 border-8 border-pk rounded-xl hover:scale-110 duration-500 ">
            ...
            <div className="p-8 space-y-3  border-pk border-8 rounded-xl hover:scale-110 duration-500 ">
                <span className="inline-block text-blue-500 dark:text-blue-400">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="#7D8AE8">
