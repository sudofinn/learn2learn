              ...
              <ul>
                {posts.map((post) => (
                  ...
                  >
                    ...
                    <h3 className={`text-2xl lg:text-3xl mt-4 mb-8  items-center px-6 py-2  duration-300 transition text-black rounded `}>{post.shareCount} </h3>
                    <Image src={post.image} alt="Finance img" />
